...
declare -a TARGETS=(
  ...
  "pocket       -DPCB=X7  -DPCBREV=POCKET   -DUSE_FW_LTO=y"
  "tx12mk2      -DPCB=X7  -DPCBREV=TX12MK2  -DUSE_FW_LTO=y"
  "zorro        -DPCB=X7  -DPCBREV=ZORRO    -DUSE_FW_LTO=y"
  "tx15         -DPCB=TX15"
  "tx16s        -DPCB=X10 -DPCBREV=TX16S"
  "tx16smk3     -DPCB=TX16SMK3"
  # ---- Jumper ----
  "bumblebee    -DPCB=X7  -DPCBREV=BUMBLEBEE -DUSE_FW_LTO=y"
  "t12max       -DPCB=X7  -DPCBREV=T12MAX    -DUSE_FW_LTO=y"
  "t14          -DPCB=X7  -DPCBREV=T14       -DUSE_FW_LTO=y"
  "t20          -DPCB=X7  -DPCBREV=T20       -DUSE_FW_LTO=y"
  "t20v2        -DPCB=X7  -DPCBREV=T20V2     -DUSE_FW_LTO=y"
  "tpros        -DPCB=X7  -DPCBREV=TPROS     -DUSE_FW_LTO=y"
  "tprov2       -DPCB=X7  -DPCBREV=TPROV2    -DUSE_FW_LTO=y"
